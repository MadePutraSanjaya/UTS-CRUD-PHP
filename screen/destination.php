        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/screen/destination.php" class="nav-link active">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Kelola Data destination</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="button-table">
                                    <a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal">Tambah destination</a>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Update Data Destination</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form role="form" action="../actions/edit.php" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Name</label>
                                                                    <input type="text" name="name_destination" class="form-control" value="<?php echo $data['name']; ?>" required>

                                                                    <label>Description</label>
                                                                    <input type="text" name="description_destination" class="form-control" value="<?php echo $data['description']; ?>" required>
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <input type="file" name="image_destination" value="<?php echo $data['image_url']; ?>">
                                                                    <br>
                                                                    <span style="color:red; font-size:12px;">Only jpg / jpeg/ png /gif format allowed. Maximum size is 1MB.</span>
                                                                </div>

                                                                <div class="modal-footer">
                                                                    <button type="submit" name="submit" class="btn btn-success">Update Destination</button>
                                            ...
                                            <div class="modal fade" id="myModal<?php echo $data['id']; ?>Delete" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Anda Yakin Ingin Menghapus Data Destination?</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form role="form" action="../actions/delete.php" method="post">
                                                                ...
                                                                <?php
                                                                $id = $data['id'];
                                                                $query_edit = mysqli_query($conn, "SELECT * FROM destination WHERE id = '$id'");
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>Description</label>
                                                                        <input type="text" name="description" class="form-control" value="<?php echo $row['description']; ?>" disabled>
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="submit" name="submit" class="btn btn-danger">Hapus Data Destination</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" action="../actions/add.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="action" value="createDestination">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name_destination" class="form-control" required>

                                <label>Description</label>
                                <input type="text" name="description_destination" class="form-control" required>

                                <div class="form-group">
                                    <input type="file" name="image_destination" required="true">
                                    <br>
                            ...
                            <div class="modal-footer">
                                <button type="submit" name="submit" class="btn btn-success">Save Data destination</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            </div>
                        </form>
